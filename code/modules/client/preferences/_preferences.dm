...
<head>
	...
	<script>
		...
		function updateCharacterData() {
			...
			if('loadout4' in data) updateField('char-loadout4', data.loadout4 || 'None');
...
<div class="ui-container">
	...
	<a href='?_src_=prefs;preference=loadout_item;loadout_number=1;task=input'><div class="sprite" style="top:194px; left:10px; width:51px; height:9px; background-image: url('loadout_item1.png');">
		<div id="char-loadout1" class="clickable-text auto-shrink" style="width:51px; height:9px;">"Access"</div>
	</div></a>
...
/datum/preferences/proc/update_menu_data(mob/user, list/fields_to_update)
	...
	if(update_all || ("loadout4" in fields_to_update))
		var/loadout4_str = _get_loadout_slot(4)
		var/datum/loadout_item/loadout4_item = loadout4_str ? GLOB.loadout_items[text2path(loadout4_str)] : null
		params["loadout4"] = loadout4_item ? loadout4_item.name : "None"
